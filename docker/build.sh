...
# Build the container
docker build docker-build -t onedsol/$CONTAINER_NAME \
                          -t onedsol/$CONTAINER_NAME:latest \
                          -t onedsol/$CONTAINER_NAME:$APP_RELEASE \
                          -t onedsol/$CONTAINER_NAME:$APP_LONG_VERSION